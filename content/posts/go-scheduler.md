---
title: "Go Scheduler"
date: 2022-03-28T18:24:31+10:00
draft: false
---
...
## Предисловие
Дизайн и поведение планировщика Go позволяет делать асинхронные программы на Go более эффективными.
Планировщик GO эффективно взаимодействует с планировщиком операционной системы, однако чтобы Ваша программа эффективно взаимодействовала с планировщиком GO вы должны понимать как он работает и как работает планировщик ОС. Тогда вы сможете разразботать асинхронную программу которая действительно быстро и корректно работает.
Я хочу сказать что когда вы понимаете как работает система то вы сможете добиться оптимальной производительности.
Это статья будет фокусироватся на высокоуровневой механике и семантике планировщиков.

## OS Scheduler - планировщик операционной системы
Планировщик ОС сложное и комплексное программное обеспечение. Чтобы принимать верные решения ему необходимо знать многие вещи о том устройстве на котором он запущен.
